...
### All resources are provisioned on `us-east-1`(update <a>[tfvars](https://github.com/devops-terraform-aws/modules/blob/main/terraform.tfvars#L2)</a> for your region)
